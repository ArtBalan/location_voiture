...
if (isset($_POST['marque']) && isset($_POST['modele']) && isset($_POST['tarif24']) && isset($_POST['tarifSemaine']) && isset($_POST['caution']) ) {
    ...
    if ($erreur == false) {
        ...
        if (empty($id)) {
            ...
            $enregistrement = $pdo->prepare("UPDATE voiture SET marque = :marque, modele = :modele, tarif24 = :tarif24, tarifSemaine = :tarifSemaine, caution = :caution WHERE id= :id");
